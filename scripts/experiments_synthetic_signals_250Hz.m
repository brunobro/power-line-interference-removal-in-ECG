...
load('ecg1_n.mat');
load('ecg1.mat');
ecg1   = downsample(ecg1, 2);
ecg1_n = downsample(ecg1_n, 2);
tic;
ecg_den1 = MyDenoising(ecg1_n, wavelet, 2, window_len);
time1 = toc;
...
load('ecg2_n.mat');
load('ecg2.mat');
ecg2   = downsample(ecg2, 2);
ecg2_n = downsample(ecg2_n, 2);
tic;
ecg_den2 = MyDenoising(ecg2_n, wavelet, 2, window_len);
time2 = toc;
...
load('ecg3_n.mat');
load('ecg3.mat');
ecg3   = downsample(ecg3, 2);
ecg3_n = downsample(ecg3_n, 2);
tic;
ecg_den3 = MyDenoising(ecg3_n, wavelet, 2, window_len);
time3 = toc;
...
load('ecg4_n.mat');
load('ecg4.mat');
ecg4   = downsample(ecg4, 2);
ecg4_n = downsample(ecg4_n, 2);
tic;
ecg_den4 = MyDenoising(ecg4_n, wavelet, 2, window_len);
time4 = toc;
...
load('ecg5_n.mat');
load('ecg5.mat');
ecg5   = downsample(ecg5, 2);
ecg5_n = downsample(ecg5_n, 2);
tic;
ecg_den5 = MyDenoising(ecg5_n, wavelet, 2, window_len);
time5 = toc;
...
load('ecg6_n.mat');
load('ecg6.mat');
ecg6   = downsample(ecg6, 2);
ecg6_n = downsample(ecg6_n, 2);
tic;
ecg_den6 = MyDenoising(ecg6_n, wavelet, 2, window_len);
time6 = toc;
...
load('ecg7_n.mat');
load('ecg7.mat');
ecg7   = downsample(ecg7, 2);
ecg7_n = downsample(ecg7_n, 2);
tic;
ecg_den7 = MyDenoising(ecg7_n, wavelet, 2, window_len);
time7 = toc;
...
load('ecg8_n.mat');
load('ecg8.mat');
ecg8   = downsample(ecg8, 2);
ecg8_n = downsample(ecg8_n, 2);
tic;
ecg_den8 = MyDenoising(ecg8_n, wavelet, 2, window_len);
time8 = toc;
...
load('ecg9_n.mat');
load('ecg9.mat');
ecg9   = downsample(ecg9, 2);
ecg9_n = downsample(ecg9_n, 2);
tic;
ecg_den9 = MyDenoising(ecg9_n, wavelet, 2, window_len);
time9 = toc;
...
load('ecg10_n.mat');
load('ecg10.mat');
ecg10   = downsample(ecg10, 2);
ecg10_n = downsample(ecg10_n, 2);
tic;
ecg_den10 = MyDenoising(ecg10_n, wavelet, 2, window_len);
time10 = toc;
...
load('ecg11_n.mat');
load('ecg11.mat');
ecg11   = downsample(ecg11, 2);
ecg11_n = downsample(ecg11_n, 2);
tic;
ecg_den11 = MyDenoising(ecg11_n, wavelet, 2, window_len);
time11 = toc;
...
load('ecg12_n.mat');
load('ecg12.mat');
ecg12   = downsample(ecg12, 2);
ecg12_n = downsample(ecg12_n, 2);
tic;
ecg_den12 = MyDenoising(ecg12_n, wavelet, 2, window_len);
time12 = toc;
...
load('ecg13_n.mat');
load('ecg13.mat');
ecg13   = downsample(ecg13, 2);
ecg13_n = downsample(ecg13_n, 2);
tic;
ecg_den13 = MyDenoising(ecg13_n, wavelet, 2, window_len);
time13 = toc;
...
load('ecg14_n.mat');
load('ecg14.mat');
ecg14   = downsample(ecg14, 2);
ecg14_n = downsample(ecg14_n, 2);
tic;
ecg_den14 = MyDenoising(ecg14_n, wavelet, 2, window_len);
time14 = toc;
...
load('ecg15_n.mat');
load('ecg15.mat');
ecg15   = downsample(ecg15, 2);
ecg15_n = downsample(ecg15_n, 2);
tic;
ecg_den15 = MyDenoising(ecg15_n, wavelet, 2, window_len);
time15 = toc;
...
load('ecg16_n.mat');
load('ecg16.mat');
ecg16   = downsample(ecg16, 2);
ecg16_n = downsample(ecg16_n, 2);
tic;
ecg_den16 = MyDenoising(ecg16_n, wavelet, 2, window_len);
time16 = toc;
...
load('ecg17_n.mat');
load('ecg17.mat');
ecg17   = downsample(ecg17, 2);
ecg17_n = downsample(ecg17_n, 2);
tic;
ecg_den17 = MyDenoising(ecg17_n, wavelet, 2, window_len);
time17 = toc;
...
load('ecg18_n.mat');
load('ecg18.mat');
ecg18   = downsample(ecg18, 2);
ecg18_n = downsample(ecg18_n, 2);
tic;
ecg_den18 = MyDenoising(ecg18_n, wavelet, 2, window_len);
time18 = toc;
...
load('ecg19_n.mat');
load('ecg19.mat');
ecg19   = downsample(ecg19, 2);
ecg19_n = downsample(ecg19_n, 2);
tic;
ecg_den19 = MyDenoising(ecg19_n, wavelet, 2, window_len);
time19 = toc;
...
load('ecg20_n.mat');
load('ecg20.mat');
ecg20   = downsample(ecg20, 2);
ecg20_n = downsample(ecg20_n, 2);
tic;
ecg_den20 = MyDenoising(ecg20_n, wavelet, 2, window_len);
time20 = toc;
